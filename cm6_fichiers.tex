...
\begin{frame}[fragile]{Fichiers CSV}
  ...
  \begin{columns}
    ...
    \begin{column}{0.52\textwidth}
      ...
      \center{\mintinline{python}|csv.DictWriter|}
...
\begin{frame}[fragile]{Fermeture des fichiers après écriture}
  \begin{itemize}
    ...
    \begin{itemize}
      \item \mintinline{python}|fp.close()|
      \item s'exécute aussi si la variable \mintinline{python}|fp| est supprimée (à la sortie d'une fonction par exemple)
    \end{itemize}
  \end{itemize}
\end{frame}
